...
* **Physics-informed DMD with Control (PiDMDc):** Combines physics-informed manifold constraints (Baddoo et al. 2023) with DMD with control (Proctor et al. 2016). Constrains A to a matrix manifold while learning the control input matrix B.
